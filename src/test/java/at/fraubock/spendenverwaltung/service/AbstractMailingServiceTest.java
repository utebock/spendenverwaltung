...
public class AbstractMailingServiceTest {
	...
	public void init() {
		...
		validCriterion.compare(FilterProperty.PERSON_GIVENNAME, RelationalOperator.EQUALS, "Person");
	...
	public void createWrapsException_shouldThrowServiceException() throws ServiceException {
		try {
			doThrow(new PersistenceException()).when(mailingDAO).insertOrUpdate(invalidMailing);
	...
	@Test(expected = ServiceException.class)
	public void deleteMailing_shouldThrowServiceException() throws ServiceException {
		try {
			doThrow(new PersistenceException()).when(mailingDAO).delete(invalidMailing);
	...
	@Test(expected = ServiceException.class)
	public void getMailingsById_shouldThrowServiceException() throws ServiceException {
		try {
	...
	@Test(expected = ServiceException.class)
	public void getMailingsByPerson_shouldThrowServiceException() throws ServiceException {
		try {
			Person invalidPerson = new Person();
			invalidPerson.setGivenName("Invalid");
			doThrow(new PersistenceException()).when(mailingDAO).getMailingsByPerson(invalidPerson);
