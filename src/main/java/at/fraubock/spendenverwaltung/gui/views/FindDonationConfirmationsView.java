...
public class FindDonationConfirmationsView extends InitializableView {
	...
	private PersonTableModel ConfirmationModel;
	...
	public FindDonationConfirmationsView(IPersonService personService,
			IAddressService addressService, IDonationService donationService,
			IFilterService filterService, IConfirmationService confirmationService, ComponentFactory componentFactory,
	...
	public void initTable() {
		if (ConfirmationModel == null) {
			ConfirmationModel = new PersonTableModel();
		}
	...
	private final class exportActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (fileChooser.showSaveDialog(FindDonationConfirmationsView.this) == JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					JOptionPane.showMessageDialog(FindDonationConfirmationsView.this,
	...
	private final class EditAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			person = ConfirmationModel.getPersonRow(row);
	...
	private final class DeleteAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			p = ConfirmationModel.getPersonRow(row);
			...
			if (ok == 1) {
				try {
					...
					ConfirmationModel.removePerson(row);
