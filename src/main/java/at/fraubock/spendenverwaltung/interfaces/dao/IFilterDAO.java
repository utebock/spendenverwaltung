...
public interface IFilterDAO {
	 ...
	 * yet existent) or updates the filter with the already existent id. If the
	 * filter is inserted, its id will and other fields may be set.
	 * 
	 * @param p
	 ...
	 * @return the filter stored with the given id, or
