...
INSERT INTO `filter` (`id`,`criterion`,`type`,`name`,`anonymous`,`privacy_status`,`owner`) VALUES (8,22,'validated_persons','GroßFettDauerspender',0,'anzeigen','default_filter_owner');
